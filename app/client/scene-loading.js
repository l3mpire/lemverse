...
LoadingScene = new Phaser.Class({
  ...
  create(visible = true) {
    ...
    this.background.fillRect(-document.documentElement.clientWidth / 2, -document.documentElement.clientHeight / 2, document.documentElement.clientWidth, document.documentElement.clientHeight);

    this.background_characters = this.add.tileSprite(-document.documentElement.clientWidth / 2, -document.documentElement.clientHeight / 2, document.documentElement.clientWidth * 2, document.documentElement.clientHeight * 2, 'scene-loader-background');
    ...
    this.container = this.add.container(document.documentElement.clientWidth / 2, document.documentElement.clientHeight / 2);
  ...
  update(time, delta) {
    this.container.setPosition(document.documentElement.clientWidth / 2, document.documentElement.clientHeight / 2);
